...
::: tip Pre-requisites
Make sure you understand the [hosting models](/multiplayer-servers/running-game-servers/identifying-your-hosting-model) and have your [environment set up](/multiplayer-servers/operations/setup-your-environment) before configuring cloud capacity.
:::

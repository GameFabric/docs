...
GameFabric Cloud enables provisioning and deprovisioning of cloud [Locations](/multiplayer-servers/getting-started/glossary#location)
...
As described in [Setup your Environment](/multiplayer-servers/operations/setup-your-environment#create-a-region), [Regions](/multiplayer-servers/getting-started/glossary#region)
...
Once the cloud Location has been provisioned, the assigned number of [Sites](/multiplayer-servers/getting-started/glossary#site) (usually one) is shown in the Locations dashboard.

...
To provision GameFabric Cloud capacity, see [GameFabric Cloud](/multiplayer-servers/running-game-servers/gamefabric-cloud).
...
To set up BYOC, see [Configuring your Cloud Provider](/multiplayer-servers/running-game-servers/cloud-provider-setup).
...
Use [Region Types](/multiplayer-servers/operations/setup-your-environment#create-a-region) to prioritize how game servers are distributed across different capacity types.

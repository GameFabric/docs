...
Note the username and password for your Service Account, and use them to log in as described in the [Pushing Container Images](/multiplayer-servers/container-images/pushing-container-images) guide.

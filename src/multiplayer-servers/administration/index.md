...
- [Getting access](/multiplayer-servers/administration/getting-access) — sign in, and what to do
...
Actions taken by users and service accounts are recorded in
[audit logs](/multiplayer-servers/operate/audit-logs). To use a service account against the API,
see the [API guide](/multiplayer-servers/api/guide).

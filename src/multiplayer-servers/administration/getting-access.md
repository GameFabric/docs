...
The **Log in with Email** option is not recommended for regular users, but rather for temporary access or verifying service account access. See [Service Accounts](/multiplayer-servers/administration/service-accounts) for more information.
...
For information on configuring custom SSO providers, see [Setup Third-Party OAuth Integration](/multiplayer-servers/administration/oidc-providers).
...
1. The [**groups**](/multiplayer-servers/administration/permissions#group) they belong to
2. The [**roles**](/multiplayer-servers/administration/permissions#role) assigned to those groups
3. The **permissions** defined in those roles

For detailed information on configuring permissions, see [Editing Permissions](/multiplayer-servers/administration/permissions).

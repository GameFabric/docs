...
- A game server binary ready for containerization (see [Building a Container Image](/multiplayer-servers/container-images/building-a-container-image))
...
A [Branch](/multiplayer-servers/get-started/glossary#branch) stores your container images and organizes them into separate tracks. In a typical setup, you might have one Branch for development builds and another for production.

Create a Branch in the GameFabric UI under **Container Images > Branches**.

[Detailed guide: Create a Branch](/multiplayer-servers/container-images/pushing-container-images#create-a-branch)
...
[Detailed guide: Building a Container Image](/multiplayer-servers/container-images/building-a-container-image)
...
[Detailed guide: Pushing Container Images](/multiplayer-servers/container-images/pushing-container-images)

### 4. Create an Environment

An [Environment](/multiplayer-servers/get-started/glossary#environment) isolates groups of resources, ensuring they don't interfere with each other. This allows you to manage capacity and access control separately for each Environment.

Create an Environment in the GameFabric UI under **Multiplayer Servers > Environments**.

[Detailed guide: Setup your Environment](/multiplayer-servers/configure/environments-and-regions)

### 5. Create a Region

A [Region](/multiplayer-servers/get-started/glossary#region) groups one or more [Locations](/multiplayer-servers/get-started/glossary#location) where your game servers can run. You can assign priorities to Locations within a Region to control which Locations are filled first.

Create a Region within your Environment in the GameFabric UI.

[Detailed guide: Setup your Environment](/multiplayer-servers/configure/environments-and-regions#create-a-region)
...
The external port will be different from your configured game server port. If your server needs to advertise its address to external services (like Steam or a server browser), see [Discovering Your Public Address](/multiplayer-servers/integrate/your-game-server#discovering-your-public-address).
:::

[Detailed guide: Running your Game Server](/multiplayer-servers/deploy/vessels)
...
- [Using the Agones SDK](/multiplayer-servers/integrate/your-game-server) - Integrate proper health checks and lifecycle management
- [Hosting Models](/multiplayer-servers/concepts/hosting-models) - Choose between Armadas and Formations

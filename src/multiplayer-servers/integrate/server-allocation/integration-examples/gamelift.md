...
- For general allocation guidance, see [Allocating from Armadas](/multiplayer-servers/integrate/server-allocation/allocating-from-armadas)
- For the Allocator API specification, see [Allocator API](/api/multiplayer-servers/allocation-allocator)
- For Agones SDK integration, see [Using the Agones SDK](/multiplayer-servers/integrate/your-game-server)

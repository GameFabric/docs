...
For background on sidecar containers and other available sidecars, see [Sidecar Containers](/multiplayer-servers/concepts/sidecars).
:::
...
Please check [Using the Agones SDK](/multiplayer-servers/integrate/your-game-server) for details.
...
If your Region has a managed [Allocator](/multiplayer-servers/concepts/allocators) attached,
...
[migration guidance](/multiplayer-servers/concepts/allocators#migrating-from-manual-configuration)

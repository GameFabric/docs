...
For background on sidecar containers and the Allocation Sidecar specifically, see [Sidecar Containers](/multiplayer-servers/concepts/sidecars).
:::
...
3. Have integrated the [Agones SDK](/multiplayer-servers/integrate/your-game-server) for game server lifecycle management.

...
| `service_account` | The email address of the [Service Account](/multiplayer-servers/administration/service-accounts#managing-service-accounts) used for authentication. |

## Authentication

The provider requires a [Service Account](/multiplayer-servers/administration/service-accounts#managing-service-accounts) for authentication. Set the `GAMEFABRIC_PASSWORD` environment variable:

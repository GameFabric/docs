...
The game server must [manually call the Registry endpoint to register itself](/multiplayer-servers/integrate/server-allocation/manually-registering-game-servers)
or use the Allocation Sidecar to [handle registration automatically](/multiplayer-servers/integrate/server-allocation/automatically-registering-game-servers).
...
- For an overview of what the Allocation Sidecar is and when to use it, see
  [Sidecar Containers](/multiplayer-servers/concepts/sidecars#allocation-sidecar).

...
[GameFabric Cloud self-service](/multiplayer-servers/configure/gamefabric-cloud)).
...
See [Capacity Types](/multiplayer-servers/concepts/capacity-types) for details on bare metal,
...
See [Allocators](/multiplayer-servers/concepts/allocators) for full details, including the
automatic environment variable injection, override priority rules, and migration guidance for
existing regions. See [Ping Services](/multiplayer-servers/concepts/ping-services) for details

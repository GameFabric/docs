...
Bare metal Locations are not configurable through the GameFabric UI. To request additional bare metal capacity, submit a request via the [GameFabric Help Center](/multiplayer-servers/get-started/glossary#gamefabric-help-center).
...
To provision GameFabric Cloud capacity, see [GameFabric Cloud](/multiplayer-servers/configure/gamefabric-cloud).
...
To set up BYOC, see [Configuring your Cloud Provider](/multiplayer-servers/configure/cloud-provider-setup).
...
Use [Region Types](/multiplayer-servers/configure/environments-and-regions#create-a-region) to prioritize how game servers are distributed across different capacity types.

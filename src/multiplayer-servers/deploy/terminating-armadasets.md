...
For more information about ArmadaSets and how they work, see the [Glossary](/multiplayer-servers/get-started/glossary#armadaset) and [Hosting Models](/multiplayer-servers/concepts/hosting-models#armadas).
:::
...
For more information about how allocation is tracked, see the [Using the Agones SDK](/multiplayer-servers/integrate/your-game-server) section.

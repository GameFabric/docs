...
For the game server states exposed by the Agones SDK (`Ready`, `Allocated`, and so on), see [Game server lifecycle](/multiplayer-servers/integrate/game-server-lifecycle).
:::
...
- [Terminating game servers](/multiplayer-servers/deploy/terminating-game-servers) — how shutdown hints and grace periods work for vessels.
- [Game server lifecycle](/multiplayer-servers/integrate/game-server-lifecycle) — the Agones SDK states your game server reports (`Ready`, `Allocated`, `Shutdown`).
- [Vessel (glossary)](/multiplayer-servers/get-started/glossary#vessel) — definition and context.

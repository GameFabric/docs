...
If the game server is not [integrated properly](/multiplayer-servers/integrate/your-game-server) or if bugs or other issues occur, it may lead to a situation where a manual shutdown is required. This part of the document describes the process.

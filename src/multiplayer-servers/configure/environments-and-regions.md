...
::: tip Key Concepts
Before proceeding, review the [Glossary](/multiplayer-servers/get-started/glossary) to understand key concepts like Environments, Regions, Locations, and Sites.
:::
...
1. [Create and manage Service Accounts](/multiplayer-servers/administration/service-accounts)
2. [Build and push your container image](/multiplayer-servers/container-images/building-a-container-image)
3. [Deploy your game servers](/multiplayer-servers/deploy/vessels)
:::
...
The name of the Environment uniquely identifies it and is restricted to a maximum of 4 letters (see [Quotas](/multiplayer-servers/configure/quotas#name-length) for details).

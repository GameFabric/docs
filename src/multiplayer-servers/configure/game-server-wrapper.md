...
- Your game server is integrated against the Agones SDK (see [Using the Agones SDK](/multiplayer-servers/integrate/your-game-server)),
...
Tailed logs count toward the [logging quotas](/multiplayer-servers/configure/quotas#logging-limitations).

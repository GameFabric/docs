...
For full lifecycle guidance, see [Requirements and best practices](/multiplayer-servers/operate/production-requirements#lifecycle-management).
...
When building your container images, make sure to configure the user as shown in the [Building a Container Image](/multiplayer-servers/container-images/building-a-container-image) guide.
:::

...
1. [Push it to the GameFabric registry](/multiplayer-servers/integration/pushing-container-images)
2. [Run your game server](/multiplayer-servers/operations/running-your-game-server) using the image
3. Integrate the [Agones SDK](/multiplayer-servers/integration/using-the-agones-sdk) for proper lifecycle management
:::

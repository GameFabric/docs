...
1. [Build your container image](/multiplayer-servers/integration/building-a-container-image)
2. **Push it to the registry** (this guide)
3. [Run your game server](/multiplayer-servers/operations/running-your-game-server)
:::
...
* **Add default Branches**: This will create two branches, "Production" and "Development", with default Image Retention Policies. Don't worry - you can always change the display names and policies later. See how to [edit a branch](/multiplayer-servers/operations/edit-a-branch).

...
For more details on creating a compatible container, see [Building a Container Image](/multiplayer-servers/container-images/building-a-container-image).
...
See [Using the Agones SDK](/multiplayer-servers/integrate/your-game-server) for implementation details.

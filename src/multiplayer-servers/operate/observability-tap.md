...
description: "The observability tap gives you direct, read-only access to the Prometheus-compatible metrics API and the Loki-compatible logs API for your GameFabric instal..."
---
...
Access to the observability tap is not enabled by default. To request it, contact your **Customer Success Manager** or raise a request through the **[GameFabric Help Center](/multiplayer-servers/get-started/glossary#gamefabric-help-center)**. Once approved, your Customer Success Manager provides the Bearer token needed to authenticate against the endpoints.

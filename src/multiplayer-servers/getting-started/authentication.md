...
> **Note:** The access token is only **valid for 24 hours**. Once it expires, you need to generate a new token using your service account credentials or use a refresh token (need to add scope `offline_access`).

...
GameFabrics offers and own Terraform provider to interact with the plattform. Please see the dedicated documentation under [Terraform provider](/multiplayer-servers/integration/your-backend#terraform-provider).

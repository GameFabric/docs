...
The name of the Environment uniquely identifies it and is restricted to a maximum of 4 letters (see [Quotas](/multiplayer-servers/multiplayer-services/quotas#environment-name-length) for details).

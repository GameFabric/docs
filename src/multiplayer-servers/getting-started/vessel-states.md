...
| `Running` | The game server is ready to accept or is actively serving players. | This is the healthy steady state. The game server has called `Ready()`, `Allocate()`, or reached an equivalent ready condition. |
